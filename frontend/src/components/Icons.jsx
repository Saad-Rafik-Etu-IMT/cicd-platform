// Professional SVG Icons - Lucide/Feather style
// Consistent 24x24 viewBox with 2px stroke
...
export const Icons = {
  ...
  docker: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 12.5c-.5-1.5-2-2.5-4-2.5-1 0-2 .5-2.5 1"/>
      <rect x="2" y="10" width="4" height="4" rx="0.5"/>
      <rect x="7" y="10" width="4" height="4" rx="0.5"/>
      <rect x="12" y="10" width="4" height="4" rx="0.5"/>
      <rect x="7" y="5" width="4" height="4" rx="0.5"/>
      <rect x="12" y="5" width="4" height="4" rx="0.5"/>
      <path d="M2 15c0 2.5 2 4.5 5 5 3 .5 7 0 10-2 2-1.5 3.5-3.5 4-5"/>
    </svg>
  ),
  ...
  deploy: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect width="14" height="8" x="2" y="2" rx="2"/>
    </svg>
  ),
...
// Icon component for easier usage
